...
const CONTACT_PHONE = process.env.NEXT_PUBLIC_CONTACT_PHONE || "0948386873";
const ZALO_URL = process.env.NEXT_PUBLIC_ZALO_URL || "https://zalo.me/0948386873";
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || "https://vay.leadity.ai";
...
const structuredData = {
  ...
  url: SITE_URL,
  logo: `${SITE_URL}/assets/leadity-logo.png`,
  contactPoint: {
    "@type": "ContactPoint",
    telephone: `+84-${CONTACT_PHONE.replace(/^0/, '')}`,
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Chúng tôi là môi giới khoản vay thế chấp chuyên nghiệp, kết nối bạn với các ngân hàng hàng đầu để tìm gói vay phù hợp nhất với nhu cầu và khả năng tài chính của bạn
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-[#7CD734]/20 to-[#4DC614]/20 rounded-2xl p-8 text-center border border-[#7CD734]/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                Gọi: {CONTACT_PHONE.replace(/(\d{4})(\d{3})(\d{3})/, '$1 $2 $3')}
              </a>
            </div>
          </div>
